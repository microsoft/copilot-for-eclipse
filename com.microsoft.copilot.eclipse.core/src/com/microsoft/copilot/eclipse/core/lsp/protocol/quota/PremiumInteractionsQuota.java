...
/**
 * Premium interactions quota information.
 */
public class PremiumInteractionsQuota {
  private double percentRemaining;
  private boolean unlimited;
  private boolean overagePermitted;

  /**
   * Creates a new PremiumInteractions quota information with default values.
   */
  public PremiumInteractionsQuota() {
  ...
  public boolean equals(Object obj) {
    ...
    PremiumInteractionsQuota other = (PremiumInteractionsQuota) obj;
