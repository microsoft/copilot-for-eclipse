...
/**
 * Handler for refreshing agent jobs in the Jobs View.
 */
public class RefreshAgentJobsHandler {

  /**
   * Check if the refresh command can be executed.
   *
  ...
  /**
   * Execute the refresh command by sending an event.
   *
   * @param eventBroker the event broker
   */
  @Execute
  public void execute(IEventBroker eventBroker) {
    eventBroker.post(JobsViewEvents.TOPIC_REFRESH, null);
  }
}
